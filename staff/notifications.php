...
*/
   $staff_id = $_SESSION['staff'];
    $officeData = $staff->findOne(['_id'=>$staff_id]);
    $office_id = $officeData->office_id;
    $notifcationsData=$notification->Find(['office_id'=>$office_id]);
			...
			<div class="content">
                ...
                <div style="padding: 10px;">
                    ...
                    <table class="table table-bordered table-striped" width="100%">
                        ...
                        <?php foreach ($notifcationsData as $notification): ?>
                            <tr>
                              <td><?php echo $notification->content; ?></td>
                              <td><?php echo ($notification->add_time) ?></td>
                            </tr>
                        <?php endforeach ?>
