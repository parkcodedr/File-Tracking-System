...
$routeData=$routes->find(['to_id'=>$staffData->office_id]);
	...
	<div class="wrapper">
		...
		<div class="main-panel">
          ...
          <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                      <?php foreach ($routeData as $data){
                            $count = 1;
                        
                            $fileObject=$file->findOne(['_id'=>$data->file_id,'dispatch'=>0]);
                                
                                $createdUserObject=$user->findOne(['_id'=>$fileObject->user_id]);
                            ...
                            <tr>
                              ...
                              <td>
                                  <?php if ($fileObject->attached): ?>
                                    <a  href="/file/<?php echo $fileObject->attached ?>" download="<?php echo $fileObject->attached?>"><button class="btn btn-sm btn-primary">Download</button></a> 
                                  <?php endif ?>
                                  <!--<a  href="track.php?file_id=<?php //echo $fileObject->_id; ?>"><button class="btn btn-sm btn-primary">Track</button></a>--> 
                                  
                                    <a  href="dispatch.php?file_id=<?php echo $fileObject->_id; ?>"><button class="btn btn-sm btn-primary">Dispatch</button></a> 
