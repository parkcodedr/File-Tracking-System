...
$staff = $tracker->staff;
$admin=$tracker->admin;
$staffCount = $staff->find([]);
$userCount = $user->find([]);
$mailCount = $file->find([]);

$adminData=$admin->findOne(['_id'=>$admin_id]);
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											<h4>Admin</h4>
											<h3><?php echo "Welcome ".$adminData->email; ?></h3>
									...
									<div class="row">
										...
										<div class="col col-stats">
											<div class="numbers">
												...
												<h4 class="card-title"><?php foreach($staffCount as $count){
													$c=1;
									...
									<div class="row">
										...
										<div class="col col-stats">
											<div class="numbers">
												...
												<h4 class="card-title"><?php echo @count($userCount);  ?></h4>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col col-stats">
											<div class="numbers">
												...
												<h4 class="card-title"><?php echo @count($mailCount);  ?></h4>
											</div>
										</div>
									</div>
								</div>
